...
export class PersonaTable1762223843140 implements MigrationInterface {
    name = 'PersonaTable1762223843140'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "app_user" ADD "email" character varying NOT NULL`);
